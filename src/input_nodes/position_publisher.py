...
class PositionPublisher(Node):
    def __init__(self, sensorData): # make all publisher constructors take in node name and topic name
        super().__init__('image_publisher')
        self.publisher = self.create_publisher(PointStamped, 'position_topic', 10)
...
def main(args=None):
    ...
    position_publisher = PositionPublisher(sensor_publisher)
